export default function ContactUsPage() {
    return (
        <div className="container mx-auto mt-3 grid grid-flow-col-1 md:grid-cols-5 gap-8 p-2">
            <h1 className="text-3xl text-center heading font-bold text-gray-600 col-span-1 md:col-span-5">Contact Us</h1>
            <div className="mt-3 col-span-5 md:col-span-3 card shadow-xl p-3 ">
                ...
                <form action="" className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="mt-3">
                        ...
                        <input type="text" name="phone" id="phone" className="w-full border border-gray-300 rounded-md p-2" />
                    </div>
                    {/* select a country */}
                    <div className="mt-3">
                        <label htmlFor="country" className="text-gray-600">Country</label>
                        <select name="country" id="country" className="w-full border border-gray-300 rounded-md p-2">
                    ...
                    <div className="mt-3">
                        ...
                        <textarea name="message" id="message" className="w-full border border-gray-300 rounded-md p-2"></textarea>
                    </div>
                    <div className="mt-3 col-span-2 flex justify-end">
                        <button className="btn btn-wide rounded-md" type="submit">Submit</button>
                    </div>
                </form>
            </div>
            <div className=" col-span-5 md:col-span-2">
                <div className="card bg-base-100 shad ">
                    <div className="card-body">
                        <footer className="footer footer-center  bg-primary text-primary-content p-2 rounded-md">
                            <aside>
                                ...
                                <p className="font-bold">
                                    Hike to high Industries Ltd. <br />Providing reliable tech since 1992
                                </p>
